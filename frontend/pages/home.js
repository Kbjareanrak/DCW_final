...
const Home = ({ token }) => {
  ...
  const descPart = () => (
    <div className={styles.para}>
      <p>เป็นเว็บยืมหนังสือของร้าน BOR Shop (อ่านว่า บี โอ อาร์ ช็อป) คุณลูกค้าสามารถเลือกรายการหนังสือที่ต้องการหยิบยืมได้ แล้วทำการมารับหนังสือ พร้อมกับชำระเงินที่หน้าร้านค่ะ</p>
